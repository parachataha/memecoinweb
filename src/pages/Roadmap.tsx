...
const Roadmap: FunctionComponent = () => {
  return (
    <div className="w-full h-full overflow-y-auto relative overflow-hidden text-white font-freckle-face">
      ...
      <div className="flex flex-col items-center mt-32 space-y-8 lg:space-y-8">
        <div className="shadow-[0px_4px_4px_rgba(0,_0,_0,_0.6)] rounded-31xl lg:mr-[400px] bg-blue-700 w-[90%] md:w-[70%] lg:w-[50%] max-w-[300px] h-auto p-4 border-4 border-orange-500">
        ...
        <div className="shadow-[0px_4px_4px_rgba(0,_0,_0,_0.6)] rounded-31xl lg:ml-[400px] bg-blue-700 w-[90%] md:w-[70%] lg:w-[50%] max-w-[300px] h-auto p-4 border-4 border-orange-500">
          <h2 className="text-11xl mb-2">Q2 2024: Community Engagement and Partnerships</h2>
          <ul className="text-xl">
            <li className="mb-2">
        ...
        <div className="shadow-[0px_4px_4px_rgba(0,_0,_0,_0.6)] rounded-31xl lg:mr-[400px] bg-blue-700 w-[90%] md:w-[70%] lg:w-[50%] max-w-[300px] h-auto p-4 border-4 border-orange-500">
          <h2 className="text-11xl mb-2">Q3 2024: MemeCoin Olympics Main Events</h2>
          <ul className="text-xl">
            <li className="mb-2">
        ...
        <div className="shadow-[0px_4px_4px_rgba(0,_0,_0,_0.6)] rounded-31xl lg:ml-[400px] bg-blue-700 w-[90%] md:w-[70%] lg:w-[50%] max-w-[300px] h-auto p-4 border-4 border-orange-500">
          <h2 className="text-11xl mb-2">Q4 2025: Grand Finale and Token Rewards</h2>
          <ul className="text-xl">
            <li className="mb-2">Host the grand finale event with massive community participation.</li>
            <li className="mb-2">Declare the winning blockchain based on the highest market cap increase.</li>
            <li>Distribute rewards and special edition tokens to participants and top holders.</li>
          </ul>
        </div>
      </div>
    </div>
